...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Exclude login/register forms which have their own handlers
    ...
    // 7. Auth Check & Header Animation (uses MockAuth if available)
    const checkAuthStatus = () => {
        try {
            ...
            if (window.MockAuth && window.MockAuth.isLoggedIn()) {
                ...
                // Update mobile nav (both versions)
                const mobileHtml = `
